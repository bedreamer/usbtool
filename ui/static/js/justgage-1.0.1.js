...
JustGage = function(config) { 
  ...
  // value
  this.txtValue = this.canvas.text(this.params.valueX, this.params.valueY, this.originalValue + this.config.unit);
  this.txtValue. attr({
...
JustGage.prototype.refresh = function(val) {
  ...
  this.canvas.getById(this.config.id+"-txtvalue").attr({"text":originalVal + this.config.unit});
